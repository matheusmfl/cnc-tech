...
function MenuItem({ icon, title }: MenuItems) {
  return (
...
export function CollapsibleComponent() {
  ...
  return (
    <Collapsible.Root open={open} onOpenChange={setOpen}>
      <header className="bg-slate-100 color-gray-700 leading-5 flex justify-between p-5 items-center border-b border-solid border-slate-400">
        <Search size={20} />
